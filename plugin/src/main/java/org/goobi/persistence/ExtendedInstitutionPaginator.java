...
@Log4j2
public class ExtendedInstitutionPaginator extends DatabasePaginator {

    private static final long serialVersionUID = 2217523286175577311L;

    public ExtendedInstitutionPaginator(String order, String filter, IManager manager) {
